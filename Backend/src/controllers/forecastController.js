...
const generateForecast = asyncHandler(async (req, res) => {
  ...
  try {
    // Find weather data for the specified location and date
...
// Helper function to calculate solar energy based on weather data
const calculateSolarEnergy = (weatherData) => {
  //  formula: solar radiation * (1 - cloud cover/100) * 0.2
...
// Helper function to calculate wind energy based on weather data
const calculateWindEnergy = (weatherData) => {
 // formula: wind speed^3 * 0.01
